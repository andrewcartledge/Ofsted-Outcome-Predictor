...
if(!require("knitr")) install.packages("ranger", dependencies = TRUE)
...
tree_test <- data_frame(ofsted_filtered) # couldn't find ofsted_filtered_reg_tree 
                                         # so changed it to this

tree <- rpart(current_out ~ prev_out, data = tree_test, method = "class")

# these don't output nicely so I've removed them
